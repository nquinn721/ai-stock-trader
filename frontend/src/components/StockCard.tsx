...
const StockCard: React.FC<StockCardProps> = observer(
  ({ stock, signal, variant = "default" }) => {
    ...
    return (
      <div
        className={`stock-card vertical ${variant === "compact" ? "compact" : ""}`}
      >
        ...
        <div className="stock-header">
          ...
          <button
            ...
            title={
              stock.favorite ? "Remove from favorites" : "Add to favorites"
            }
          >
            <FontAwesomeIcon
              icon={faHeart}
