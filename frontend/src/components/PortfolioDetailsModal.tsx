    ...
    const fetchPortfolioPerformance = async () => {
      try {
        ...
        const performanceResponse =
          await portfolioStore.fetchPortfolioPerformance(portfolio.id);

        // Fetch portfolio details with positions and trades
        const detailsResponse = await portfolioStore.fetchPortfolioById(
          portfolio.id
        );
        ...
        setPerformance({
          ...
          dayGain: performanceResponse.dayGain || 0,
          dayGainPercent: performanceResponse.dayGainPercent || 0,
          positions,
          trades,
          analytics: {
            ...analytics,
