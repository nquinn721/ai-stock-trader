...
describe('StockAutocomplete', () => {
  ...
  it('renders input field', () => {
    render(<StockAutocomplete stocks={mockStocks} value="" onChange={mockOnChange} />);
    expect(screen.getByRole('textbox')).toBeInTheDocument();
  });

  it('displays placeholder text', () => {
    render(<StockAutocomplete stocks={mockStocks} value="" onChange={mockOnChange} placeholder="Select stock" />);
