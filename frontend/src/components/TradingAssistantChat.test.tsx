...
describe('TradingAssistantChat', () => {
  ...
  it('should render initial welcome message', () => {
    ...
    expect(screen.getByText(/Welcome to your AI Trading Assistant/)).toBeInTheDocument();
    expect(screen.getByText(/Ask me about any stock's performance/)).toBeInTheDocument();
  });
  ...
  it('should send message when send button is clicked', async () => {
    ...
    (tradingAssistantService.sendMessage as jest.Mock).mockResolvedValue(mockResponse);
    ...
    await waitFor(() => {
      expect(screen.getByText(/AAPL is currently showing strong/)).toBeInTheDocument();
    });
  });
  ...
  it('should show loading indicator while processing', async () => {
    ...
    (tradingAssistantService.sendMessage as jest.Mock).mockReturnValue(delayedPromise);
  ...
  it('should create new conversation when refresh button is clicked', async () => {
    (tradingAssistantService.createNewConversation as jest.Mock).mockResolvedValue('new-conversation-id');
