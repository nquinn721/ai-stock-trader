...
export const stories: Story[] = [
  ...
  {
    id: "S41",
    title: "Auto Trading Order Preview System",
    description:
      "Build a comprehensive order preview system that shows pending auto trading orders before execution, allowing users to see anticipated buy/sell prices, quantities, and advanced order parameters (stop-loss, take-profit) before trades are executed.",
    status: "DONE",
    priority: "High",
    epic: "E5",
    storyPoints: 8,
    ...
    progress: 100,
    dependencies: ["S19", "S25"],
    createdDate: "2025-06-30",
    completedDate: "2025-06-30",
  },
  {
    id: "S42",
    title: "Advanced Auto Trading Order Execution Engine",
    description:
      "Develop a sophisticated order execution engine that creates complete auto trading orders with stop-loss, take-profit, trailing stops, and advanced risk management features. This system will seamlessly integrate with the recommendation engine to create fully-featured trading orders.",
    status: "DONE",
    priority: "High",
    epic: "E5",
    storyPoints: 13,
  ...
  {
    id: "S44",
    title: "Daily Order Management and EOD Processing System",
    description:
      "Implement a comprehensive daily order management system that handles order lifecycle from market open to close, including end-of-day (EOD) processing, order expiration, rollover logic, and daily performance reconciliation.",
  ...
  {
    id: "S45",
    title: "Auto Trading Dashboard and Order Visualization",
    description:
      "Create a comprehensive auto trading dashboard that provides real-time visualization of pending orders, execution progress, recommendation pipeline status, and performance analytics. This dashboard will give users complete visibility into the automated trading process.",
    status: "DONE",
    priority: "High",
    epic: "E5",
    storyPoints: 13,
  ...
  },
  {
    ...
    description:
      "Implement automatic strategy assignment when starting trading in any portfolio. The system should automatically assign day trading strategies for portfolios with >$25,000 balance (PDT-eligible) and non-day trading strategies for portfolios <$25,000. This eliminates the need for manual strategy deployment while ensuring regulatory compliance with Pattern Day Trader (PDT) rules.",
    status: "DONE",
    priority: "High",
    epic: "E1",
    storyPoints: 8,
